...
<BR>
```{r echo=FALSE, fig.cap="<center><b>Insper</center></b>", out.width="50%"}
#knitr::include_graphics("img/logos/")
```

<BR>
```{r, echo=FALSE, out.width="25%", fig.cap="<center><b>RConsortium</center></b>"}
...
Haydée que contabilizar quantas pessoas participaram dos meetups das RLadies em 2019. Ela contabilizou o número de pessoas que participaram em cada evento: 
